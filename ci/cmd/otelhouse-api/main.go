...
// logs from a ClickHouse instance populated by the upstream OpenTelemetry
...
import (
	...
	"github.com/guettli/otelhouse/ci/api"
)

func main() {
	addr := flag.String("addr", ":8080", "HTTP listen address")
	dsn := flag.String("dsn", "clickhouse://test:test@localhost:9000/test", "ClickHouse DSN")
